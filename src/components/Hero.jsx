        ...
        <section className="relative min-h-[90vh] flex items-center bg-white overflow-hidden pt-20">
            ...
            <div className="container relative z-10 px-6 md:px-12">
                <div className="grid lg:grid-cols-2 gap-12 items-center h-full">
                    ...
                    {/* Left: Text Content */}
                    <div className="max-w-xl py-12 order-1 lg:order-1 relative z-20">
                        <FadeIn>
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-7xl font-heading font-bold text-gray-900 leading-[1.1] mb-8">
                                Pure <span className="text-[#e62e2e]">Comfort</span>,<br />
                                Every Day.
                            </h1>
                            <p className="text-lg md:text-xl text-gray-500 mb-8 leading-relaxed font-light max-w-lg">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link to="/products" className="px-8 py-4 bg-[#e62e2e] text-center text-white font-bold uppercase tracking-widest rounded-full hover:bg-gray-900 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1">
                                    Shop Collection
                                </Link>
                                <Link to="/contact" className="px-8 py-4 bg-white text-center text-gray-900 border border-gray-200 font-bold uppercase tracking-widest rounded-full hover:border-[#e62e2e] hover:text-[#e62e2e] transition-all shadow-sm hover:shadow-md">
                                    Partner With Us
                                </Link>
                            </div>

                            {/* Trust Badges */}
                            <div className="mt-12 flex flex-wrap items-center gap-6 text-gray-400 text-sm font-semibold uppercase tracking-wider">
                    ...
                    {/* Right: 3D Animation */}
                    <div className="h-[40vh] md:h-[500px] lg:h-[700px] w-full order-2 lg:order-2 relative z-10 -ml-4 md:ml-0">
